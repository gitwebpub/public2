...
- The function checks whether the summed evidence (i07_count) meets or exceeds a minimum threshold ([min_evidence]{.hl1}, defaulting to [1]{.hl1}).

2.3.2 Selection Decision:

- If the evidence is sufficient (i.e., i07_count >= min_evidence), 
...
- About 10 cases, Giving odd values 
...
## Step 2, Viscous agent injection1 (3)
- We decided to remove (830) for it has out of focus.
- We decided to include i09 for (292), 
- 807, 
- 295, 
- 270, 
- 278,
